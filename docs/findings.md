...
값이 2개인 `purchase_type` 은 조합을 1,708 → 5,064 로 2.96배 만듦. 같은 자리에
...
전 구간 대조. 키 5,451개 · 2019-01-07 ~ 2026-09-16.

| `rpt_` 컬럼 | 우리 쪽 | 다른 키 |
|---|---|:---:|
| `net_revenue` · `net_gross_profit` · `order_item_count` · `returned_item_count` | 대응 지표 | 0 |
| `buyer_count` | `metric_buyer_count` | 12 (HLL 오차 0.2%) |
